...
public class Partner2_MainActivity extends Fragment {
    View backArrow;
    TextView backText;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = View.inflate(getActivity(), R.layout.activity_partner2_main, null);
        ...
        map.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.nav_host_fragment_activity_bottom_navigation,
                        new MapActivity(new LatLng(2.828931134366895f, 101.70741655304674f), "")).commit();
            }
        });
